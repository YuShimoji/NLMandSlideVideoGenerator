...
| Python Tests | **570 passed, 1 skipped** | playwright未インストールのみskip |
...
- **result**: 570 passed, 1 skipped (2026-03-16)
...
| :--- | :--- | :--- | :--- | :--- |
| **短期** | TEST-COVERAGE | テストカバレッジ拡充 328→570 (61%) | **進行中** | 高 |
